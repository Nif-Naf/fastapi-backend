...
from fastapi_backend.backend.repositories.abc import AbstractRepository
from fastapi_backend.core.custom_type.user import (
    SeveralReturnType,
    SingleReturnType,
)
from fastapi_backend.core.models.user import UserModel as Model
